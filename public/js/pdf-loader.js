...
var PDFLOADER = {
	name: "PDFLOADER",
	need_preview: true,
	tool_section: $(".pdfloader_section"),
	...
	bind: function(){
		...
		$(document).on("show_only_first_page_render", function(){
			$('.popup_wrpr.select_converter').addClass('active');
		});
	},
...
if(PDFLOADER.tool_section.length>0){
	window.skip_extract = 1;
	PDFLOADER = $.extend(PDFTOOLS, PDFLOADER);
	PDFLOADER.main();
}