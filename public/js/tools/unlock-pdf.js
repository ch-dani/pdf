...
$(document).ready(function () {
        ...
        var toolUnlockPdf = {
            ...
            fileSelected: function (e, file_obj=false){
                ...
                $('.file-name-pdf').text(basename);

                if (file_ext != 'pdf') {
                    swal("Error", "Please select PDF file.", "error");
                } else {

		            toolUnlockPdf.getBlob(file).then((data) => {
                    ...
                    $(document).on('click', '#unlock-pdf', function () {
...
//                        }
                        ...
                        var intervalID = setInterval(function () {
                            ...
                            if (!toolUnlockPdf.upload_in_progress) {
...
//                                            });
                                            ...
                                            $("#apply-popup").removeClass("active");
                                            swal('Error', "m: "+data.message, 'error');
                                            password = false;
                                        }
                                    }
                                });
            ...
            uploadFile: function (file) {
                ...
                formData.append("path", 'unlock-pdf');
                formData.append("_token", $('input[name="_token"]').val());

                toolUnlockPdf.upload_in_progress = true;
                ...
                return $.ajax({
                    ...
                    success: function (data) {
                        ...
                        toolUnlockPdf.upload_in_progress = false;
                    },
                    error: function (data) {
        ...
        toolUnlockPdf.init($(".upload-file-tool"));
