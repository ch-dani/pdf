                    ...
                    loadingTask.promise.then(function (pdf) {
                        ...
                        for (currentPage = 1; currentPage <= numPages; currentPage++) {
                            ...
                            let $tmp_canvas = $(
                                ...
                                '<a class="remove-uploaded-file" href="#" data-number="' + currentPage + '"><img src="freeconvert/img/close_icon.svg"></a>' +
                                '</div>' +
                                '<div class="download_icon_doc">' +
                                '<a class="save-image-page" href="#" data-page="' + currentPage + '"><img src="freeconvert/img/download_arrow.svg"></a>' +
                                '</div>' +
                                '<div class="name_doc">' +
                                '<h6>' + filename + '</h6>' +
                                '</div>' +
...
//                                            });
        ...
        uploadFile: function (file) {
            ...
            formData.append('operation_type', 'pdf2ppt');
...
$(document).ready(function () {
    ...
    var toolPdfToJpg = {
        ...
        uploadFile: function (files) {
            ...
            formData.append("UUID", UUID);
            formData.append("path", 'pdf-to-ppt');
            formData.append("_token", $('input[name="_token"]').val());
