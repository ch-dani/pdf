...
$(document).ready(function () {
	...
	$(".download-result-link").css("background-image", "url('/img/ext/txt.svg')");
        ...
        fileSelected: function (e, file_obj = false) {
            ...
            if (file_ext != 'pdf') {
                ...
                that.getBlob(file).then((data) => {
                    ...
                    $(document).on('click', '.save-txt', function () {
                        ...
                        var intervalID = setInterval(function () {
                            ...
                            if (!toolPdfToTxt.upload_in_progress) {
...
//                                                    $(".download-result-link span").html(new_file_name);
//                                                }
//                                            });
        ...
        uploadFile: function (file) {
            ...
            formData.append("path", 'pdf-to-txt');
            formData.append("_token", $('input[name="_token"]').val());

            toolPdfToTxt.upload_in_progress = true;
            ...
            return $.ajax({
                ...
                success: function (data) {
                    ...
                    toolPdfToTxt.upload_in_progress = false;
                },
                error: function (data) {
    ...
    toolPdfToTxt.init($(".upload-file-tool"));
