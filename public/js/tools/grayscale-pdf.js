        ...
        fileSelected: function (e, file_obj=false) {
            ...
            if (file_ext != 'pdf') {
                ...
                that.getBlob(file).then((data) => {
                    ...
                    $(document).on('click', '.save-grayscale', function () {
                        ...
                        var intervalID = setInterval(function () {
                            ...
                            if (!toolGrayscale.upload_in_progress) {
                                clearInterval(intervalID);

                                $.ajax({
                                    type: 'POST',
                                    url: '/tool/grayscale-pdf',
                                    data: {
...
//                                            });
        ...
        uploadFile: function (file) {
            ...
            formData.append("path", 'grayscale-pdf');
            formData.append("_token", $('input[name="_token"]').val());

            toolGrayscale.upload_in_progress = true;
            ...
            return $.ajax({
                ...
                success: function (data) {
                    ...
                    toolGrayscale.upload_in_progress = false;
                },
                error: function (data) {
    ...
    toolGrayscale.init($(".upload-file-tool"));
