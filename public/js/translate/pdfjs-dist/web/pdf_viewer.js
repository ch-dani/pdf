    ...
    value: function render(viewport) {
      ...
      this.pdfPage.getAnnotations({ intent: intent }).then(function (annotations) {
        ...
        var parameters = {
          ...
          renderInteractiveForms: true, //_this.renderInteractiveForms,
          linkService: _this.linkService,
          downloadManager: _this.downloadManager
        };

		var page_num = (_this.pdfPage.pageIndex+1);
		var delpa = document.createElement('div');
		delpa.className = "page-side-bar";
		delpa.innerHTML = `<div data-page-id="${page_num}" class='page-tools-menu'><a href="#" data-page-id="${page_num}" class="delete-page"><img src="/img/icon-red-basked.svg" alt=""></a></div>`;
		_this.pageDiv.appendChild(delpa);
  ...
  _createClass(DefaultAnnotationLayerFactory, [{
    ...
    value: function createAnnotationLayerBuilder(pageDiv, pdfPage) {
      ...
      return new AnnotationLayerBuilder({
        ...
        renderInteractiveForms: true, //renderInteractiveForms,
...
var TextLayerBuilder = function () {
  ...
  _createClass(TextLayerBuilder, [{
    ...
    value: function render() {
    	console.log("render in pdf_viewer");
  	...
  	//console.log("this.textContentStream", this.textContentStream);
    ...
    value: function renderMatches(matches) {
      ...
      function appendTextToDiv(divIdx, fromOffset, toOffset, className) {
      	console.log("append text to div", divIdx);
...
var PDFPageView = function () {
  function PDFPageView(options) {
    ...
    this.renderInteractiveForms = true; //options.renderInteractiveForms || false;
    ...
    this.textLayer = null;
    this.zoomLayer = null;
    //TODO создание страницы
    var div = document.createElement('div');
    div.className = 'page';
    div.style.width = Math.floor(this.viewport.width) + 'px';
    div.style.height = Math.floor(this.viewport.height) + 'px';
    div.setAttribute('data-page-number', this.id);
    //TODO добавляем удалялку страниц
    
    
    this.div = div;
    container.appendChild(div);
    
    var pagesep = document.createElement('div');
    pagesep.className = "page-between";
    pagesep.appendChild(jQuery("<a href='#' class='create_new_page insert-page'>Insert Page Here</a>")[0]);
    container.appendChild(pagesep);




    //container.appendChild("<hr class='ebahr'>");
  }
  ...
  _createClass(PDFPageView, [{
    ...
    value: function paintOnCanvas(canvasWrapper) {
      ...
      var outputScale = 1; //(0, _ui_utils.getOutputScale)(ctx);
      ...
      //TODO fix dpr
      canvas.width = (0, _ui_utils.roundToDivide)(viewport.width, sfx[1]); // (0, _ui_utils.roundToDivide)(viewport.width * outputScale.sx, sfx[0]);
      canvas.height = (0, _ui_utils.roundToDivide)(viewport.height, sfy[1]); //(0, _ui_utils.roundToDivide)(viewport.height * outputScale.sy, sfy[0]);
...
//      alert(canvas.style.width+"x"+canvas.style.height);
      ...
      var renderContext = {
        ...
        renderInteractiveForms: true, //this.renderInteractiveForms
      };
  ...
  _createClass(BaseViewer, [{
    ...
    value: function _setScale(value) {
      ...
      if (scale > 0) {
        ...
        var fw_scale = (window.innerWidth*72/100) / currentPage.width * currentPage.scale;
        window.current_fw_scale = fw_scale;
