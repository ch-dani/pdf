...
<main>
    ...
    <section class="module__how-convert module bg-white pb_5">
        <div class="container">
            <div class="title-wrapper">
                <h2 class="h2-title title_main">How to Add Watermark to PDF</h2>
            ...
            <div class="row">
                <div class="col-sm-4">
                    <div class="convert">
                        ...
                        <p class="convert__p">
                            Select the PDF files or other documents you wish to protect.
                        </p>
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="convert ">
                        ...
                        <p class="convert__p">
                            Add Text or Image on your PDF as a Watermark.
                        </p>
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="convert">
                        ...
                        <p class="convert__p">
                            After adding watermark on your PDFs, select and download your PDFs to your computer.
                        </p>
                    </div>
                </div>
