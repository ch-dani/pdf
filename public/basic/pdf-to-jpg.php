...
<main>
    ...
    <section class="section_top">
        <div class="container">
            <div class="title-wrapper">
                <h2 class="h30-title title_main">Convert PDF to JPG Documents (PDF to JPG)</h2>
                <h3 class="sub-title">Creates a JPG document from PDF file (.pdf)</h3>
            </div>
    ...
    <section class="module__how-convert module bg-white">
        <div class="container">
            <div class="title-wrapper">
                <h2 class="h2-title title_main">How to convert PDF to JPG?</h2>
            </div>
            <div class="row">
                <div class="col-sm-4">
                    <div class="convert">
                ...
                <div class="col-sm-4">
                    <div class="convert ">
                        ...
                        <h4 class="convert__title">Convert PDF to JPG</h4>
                        <div class="convert-bg"></div>
                        <p class="convert__p">Convert your PDF documents into JPG files by simply clicking “Convert to JPG” and wait for it to be processed.</p>
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="convert">
                        <div class="convert__step">3</div>
                        <h4 class="convert__title">Download Your JPG Document</h4>
