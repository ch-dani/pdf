...
<main>
    <section class="section_top">
        <div class="container">
            <div class="title-wrapper">
                <h2 class="h30-title title_main">Rotate PDF</h2>
                <h3 class="sub-title">Rotate PDF pages.</h3>
            </div>
    ...
    <section class="module__how-convert module bg-white pb_5">
        <div class="container">
            <div class="title-wrapper">
                <h2 class="h2-title title_main">How to Rotate PDF Files Online Free</h2>
            ...
            <div class="row">
                <div class="col-sm-4">
                    <div class="convert">
                        ...
                        <p class="convert__p">
                            Select the PDF files or other documents you wish to rotate.
                        </p>
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="convert ">
                        ...
                        <p class="convert__p">
                            Rotate the pages you want to by clicking on arrows.
                        </p>
                    </div>
                </div>
                <div class="col-sm-4">
