...
<main>
    ...
    <section class="module__how-convert module bg-white pb_5">
        <div class="container">
            <div class="title-wrapper">
                <h2 class="h2-title title_main">How to Delete PDF Files Online Free</h2>
            ...
            <div class="row">
                <div class="col-sm-4">
                    <div class="convert">
                        ...
                        <p class="convert__p">
                            Select the PDF files or other documents you wish to delete.
                        </p>
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="convert ">
                        ...
                        <p class="convert__p">
                            Delete the pages you want to by clicking on crosses.
                        </p>
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="convert">
                        ...
                        <p class="convert__p">
                            After deleting your PDFs, select and download your deleting PDFs to your computer.
                        </p>
                    </div>
                </div>
