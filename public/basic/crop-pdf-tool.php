...
<main>
    <section class="section_top">
        <div class="container">
            <div class="title-wrapper">
                <h2 class="h30-title title_main">Crop PDF Tool</h2>
                <h3 class="sub-title">Trim and reduce PDF margins. Change PDF page size by cropping</h3>
            </div>
    ...
    <section class="module__how-convert module bg-white pb_5">
        <div class="container">
            <div class="title-wrapper">
                <h2 class="h2-title title_main">How to Crop your PDF</h2>
            ...
            <div class="row">
                <div class="col-sm-4">
                    <div class="convert">
                        ...
                        <h4 class="convert__title">Select files</h4>
                        <p class="convert__p">Select the PDF files or other documents you wish to crop.</p>
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="convert ">
                        <div class="convert__step">2</div>
                        <h4 class="convert__title">Crop files</h4>
                        <div class="convert-bg"></div>
                        <p class="convert__p">You can crop the whole document or crop specific pages individually.</p>
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="convert">
                        <div class="convert__step">3</div>
                        <h4 class="convert__title">Download files</h4>
                        <p class="convert__p">After cropping PDFs, select and download your PDFs to your computer.</p>
                    </div>
                </div>
