...
<main>
    ...
    <section class="module__how-convert module bg-white">
        <div class="container">
            <div class="title-wrapper">
                <h2 class="h2-title title_main">How to convert PDF to EPUB?</h2>
            </div>
            <div class="row">
                <div class="col-sm-4">
                    <div class="convert">
                ...
                <div class="col-sm-4">
                    <div class="convert ">
                        ...
                        <h4 class="convert__title">Convert PDF to EPUB</h4>
                        <div class="convert-bg"></div>
                        <p class="convert__p">Convert your PDF documents into EPUB files by simply clicking “Convert to EPUB” and wait for it to be processed.</p>
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="convert">
                        <div class="convert__step">3</div>
                        <h4 class="convert__title">Download Your EPUB Document</h4>
