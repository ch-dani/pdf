...
<main>
    <section class="section_top">
        <div class="container">
            <div class="title-wrapper">
                <h2 class="h30-title title_main">Fill & Sign</h2>
                <h3 class="sub-title">Fill & Sign your document</h3>
            </div>
    ...
    <section class="module__how-convert module bg-white pb_5">
        <div class="container">
            <div class="title-wrapper">
                <h2 class="h2-title title_main">How to Fill & Sign your PDF</h2>
            ...
            <div class="row">
                <div class="col-sm-4">
                    <div class="convert">
                        ...
                        <p class="convert__p">
                            Select the PDF files or other documents you wish to fill & sign.
                        </p>
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="convert ">
                        ...
                        <p class="convert__p">
                            Type text in field or add your sign to your PDF
                        </p>
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="convert">
                        ...
                        <p class="convert__p">
                            After adding sign on your PDFs, select and download your PDFs to your computer.
                        </p>
                    </div>
                </div>
