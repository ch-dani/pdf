...
<main>
    ...
    <section class="section_top">
        <div class="container">
            <div class="title-wrapper">
                <h2 class="h30-title title_main">Convert EPUB to PDF Documents (EPUB to PDF)</h2>
                <h3 class="sub-title">Creates a PDF document from EPUB file (.epub)</h3>
            </div>
                ...
                <div class="downloader__upload-wrapper">
                    <div class="downloader__doshed">
                        <div class="downloader__upload">
                            ...
                            <div class="downloader__text">Upload EPUB file</div>
    ...
    <section class="module__how-convert module bg-white">
        <div class="container">
            <div class="title-wrapper">
                <h2 class="h2-title title_main">How to convert EPUB to PDF?</h2>
            </div>
            <div class="row">
                <div class="col-sm-4">
                    <div class="convert">
                        ...
                        <p class="convert__p">To upload your files from your computer, click “Upload EPUB File” and select the files you want to edit or drag and drop the files to the page.</p>
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="convert ">
                        <div class="convert__step">2</div>
                        <h4 class="convert__title">Convert EPUB to PDF</h4>
                        <div class="convert-bg"></div>
                        <p class="convert__p">Convert your EPUB documents into PDF files by simply clicking “Convert to PDF” and wait for it to be processed.</p>
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="convert">
