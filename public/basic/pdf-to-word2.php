    ...
    <section class="section_top converting">
        <div class="container">
            <div class="title-wrapper">
                <h2 class="h30-title title_main">Convert Word to PDF Documents (DOC to PDF)</h2>
                <h3 class="sub-title">Creates a PDF document from Microsoft Word file (.docx)</h3>
            </div>
                ...
                <div class="convert_doc left_doc">
                    <div class="convert_doc_content">
                        ...
                        <div class="icon_add_doc">
                            <img src="img/icon-add-file.svg" alt="">
                    ...
                    <div class="select_wrapper" id="docSelect">
                        ...
                        <a href='#' class="select_item">
                            <img src="img/logos_google-drive.svg" alt="">
                            Google Drive
                        </a>
            ...
            <div class="link_convert">
                <div class="link_convert_left">
                    ...
                    <a href='#' class="link_convert_item">
                        <?php include "img/link_conver-2.svg"; ?>
                        Compress
                    </a>
                    <a href='#' class="link_convert_item">
                ...
                <div class="link_convert_right">
                    <a href='#' class="link_convert_item">
                        <img src="img/logo_google-drive.svg" />
