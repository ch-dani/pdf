...
class Select extends Tag
{
	...
	public function open($attr, &$ahtml, &$ihtml)
	{
		...
		if (isset($attr['MULTIPLE'])) {
			$this->mpdf->selectoption['MULTIPLE'] = false;// $attr['MULTIPLE'];
		}
		$this->mpdf->selectoption['MULTIPLE'] = false;
	...
	public function close(&$ahtml, &$ihtml)
	{
		...
		if (isset($this->mpdf->selectoption['MULTIPLE'])) {
			$objattr['multiple'] = false; // $this->mpdf->selectoption['MULTIPLE'];
		}
		$objattr['multiple'] = false; //
