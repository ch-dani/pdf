...
@section('content')
    <div class="upload-top-info">
        <div class="container">
            <div class="app-title">
                <div class="wrapper">
                    <h1>{!! array_key_exists(1, $PageBlocks) ? $PageBlocks[1] : 'Convert PDF to Grayscale' !!}</h1>
                    <p>{!! array_key_exists(2, $PageBlocks) ? $PageBlocks[2] : 'Convert PDF text and images to grayscale Export PDF for black and white or offset printing' !!}</p>
                </div>
            </div>
    ...
    <div id="extract-pdf">
        <input type="button" value="Convert PDF to Grayscale" class="save-grayscale button-task">
    </div>
    ...
    <div class="upload-top-info">
        <div class="container">
            <div class="app-title">
                <div class="wrapper">
                    <h1>{!! array_key_exists(4, $PageBlocks) ? $PageBlocks[4] : 'Ready to convert your files? Let\'s go!' !!}</h1>
                    <p>{!! array_key_exists(5, $PageBlocks) ? $PageBlocks[5] : 'Convert PDF text and images to grayscale Export PDF for black and white or offset printing' !!}</p>
                </div>
            </div>
            <div class="app-welcome">
                <form action="#">
