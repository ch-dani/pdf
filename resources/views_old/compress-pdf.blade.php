...
@section('content')
    ...
    <section id="compress_section" class="hidden after_upload">
    	<div class="options-container container">
	    	<div class="filename">Selected: <span class='current_filename'>pdf.pdf</span></div>
    		<div class="compress_options hidden">
				<div class="opt-row">
					<label class='title_label'>Image quality:</label>
					<div class="btn-group">
						@if (false)
				...
				<div class="opt-row">
					<label class='title_label'>Image resolution (ppi):</label>
					<div class="btn-group">
						<label class="btn btn-default btn-xs ">
							<input type="radio" name="image_resolution" value="72">
							72
							<span class="input-help">
						...
						<label class="btn btn-default btn-xs active">
							<input type="radio" name="image_resolution" checked value="144">
							144
							<span class="input-help">
				...
				<div class="opt-row">
					<label class='title_label'>Image conversion:</label>
					<div class="btn-group">
						<label class="btn btn-default btn-xs active">
				...
				<div class="opt-row">
					<label class='title_label'>Compression speed:</label>
					<div class="btn-group">
						<label class="btn btn-default btn-xs active">
    		...
    		<div class="button-row">
    			<button id="compress_button">Compress PDF</button>
    			<button id="more_compress_options">More options</button>
    		</div>
