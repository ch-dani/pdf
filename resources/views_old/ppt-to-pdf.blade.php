    ...
    <div class="upload-top-info">
        <div class="container">
            ...
            <div class="app-welcome">
                <form action="#" id="drop_zone" class=" before_upload">
					...
					<div class="upload-btn-wrap">
						<div class="upload-button">
							...
							<input class="user_pdf" type="file" accept="application/vnd.ms-powerpoint"  >
						</div>
				...
				<div class="after_upload hidden ppt_section">
					<div class="contact-btn" style="width: 210px; margin: 0 auto;">
						<a class="button-green" id="start_task">Convert PPT to PDF</a>
					</div>
				</div>
