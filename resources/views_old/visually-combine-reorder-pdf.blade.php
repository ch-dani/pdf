...
@section('content')
    ...
    <section class="combine-reorder-selector-wrap">
        ...
        <div id="file-page-selector-opts">
            <a href="#" id="SelectAllPanel">Select All</a>
            <a href="#" id="SelectNonePanel">Select None</a>
        </div>
    ...
    <section class="s-combine-reorder">
        <div class="combine-reorder-top-info">
            <div class="container">
                <p>Click pages to select. Shift to select multiple. Drag & drop to reorder.</p>
                ...
                <div class="combine-reorder-tools">
                    ...
                    <div class="btn-group">
                        ...
                        <ul class="dropdown-menu selection-opts">
                            ...
                            <li><a href="#" id="DeselectAll">Deselect All</a></li>
                            <li><a href="#" id="InvertSelection">Invert Selection</a></li>
                            <li class="divider"></li>
                            <li><a href="#" id="RemoveSelected">Remove Selected</a></li>
                        </ul>
                    </div>
                    <div class="btn-group">
                        <button class="btn btn-default dropdown-toggle">
                        ...
                        <ul class="dropdown-menu reorder-opts">
                            <li><a href="#" id="ReverseList">Reverse order (Last -&gt; First)</a></li>
                        </ul>
                    </div>
                    <button class="btn btn-default" id="addBlankPageBtn">
                        <i class="far fa-file"></i> Add Blank Page
                    </button>
                    <div class="btn-group">
    ...
    <section class="fixed-bottom-panel">
        <form class="fixed-task-form">
            <div class="select-dropup-bottom-btn-wrap">
                <button class="options-btn save-pdf" type="button">Save</button>
            </div>
        </form>
    </section>
