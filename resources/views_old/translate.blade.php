    		...
    		<div class="app-welcome">
    			<form action="#" id="drop_zone">
    				...
    				<div class="upload-img multiple_formats_upload">
    					...
    					<span class="multi_or">OR</span>
     					<img style="height: 98px; margin-left: 5px;" src="{{ asset('img/docx.svg') }}" alt="docx">   					
    				</div>

					<h3>UPLOAD <strong>PDF</strong> or <strong>DOCX</strong> FILE</h3>
		...
		<div class="translate_settings">
			...
			<div class="right_part">
				<div class="buttons_part">
				    <button class="options-btn on_translated_page hidden" type="button" id="save_one_page" data-page_num="1">Save page</button>
				    <button class="options-btn on_translated_page hidden" type="button" id="edit_one_page" data-page_num="1">Save & Edit page</button>
				    <button class="options-btn on_untranslated_page" type="button" id="translate_one_page" data-page_num="1">Translate page <span class="viewed_page_num">1</span></button>
				    <button class="options-btn" type="button" id="translate_all">Translate all</button>
				    <button class="options-btn on_all_translated hidden" type="button" id="save_all">Save all</button>
				    <button class="options-btn on_all_translated hidden" type="button" id="save_and_edit_all">Save & Edit all</button>
		        </div>
			</div>
		</div>
    </section>
