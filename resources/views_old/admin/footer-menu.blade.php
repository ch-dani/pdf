                        ...
                        <div class="box box-primary">
                            <div class="box-header">
                                <div style=" float: right; ">
                                    <a href="#" id="Export" style="margin-right: 0px;" class="btn btn-primary import_export_button">Export Language</a>
                                    <a href="#" id="Import" style="margin-right: 0px;" class="btn btn-danger import_export_button">Import Language</a>
                                    <input type="file" id="UploadImport" style="display: none;" multiple accept=".xls,.xlsx">
                                </div>
                            </div>
                            <div class="box-body">
