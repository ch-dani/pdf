...
@section('content')
    <div class="upload-top-info">
        <div class="container">
            <div class="app-title">
                <div class="wrapper">
                    <h1>{!! array_key_exists(1, $PageBlocks) ? $PageBlocks[1] : 'Convert Word to PDF' !!}</h1>
                    <p>{!! array_key_exists(2, $PageBlocks) ? $PageBlocks[2] : 'Creates a PDF document from Microsoft Word .docx' !!}</p>
                </div>
            </div>
    ...
    <div id="extract-pdf">
        <input type="button" value="Convert to PDF" class="button-task convert-to-pdf">
    </div>
