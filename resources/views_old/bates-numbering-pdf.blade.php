...
<section class="bates-numbering-pdf after_upload hidden" id="bates_section">
	<div class="container">
		...
		<div class="file-name-pdf">Selected: <span class='file_name_here'>Cut sheet 1.18.pdf</span></div>
		<form action="#" class="fixed-task-form">
			<div class="header-footer-content">
				<div class="hf-location-page">
					<div class="numbering-label"><span class="badge">1</span><span class="header-footer-label">Select Style</span></div>
					<select name="bates_type" class="form-control">
						...
						<option disabled="disabled" data-divider="true"></option>
						<option class="bates-select-option" value="bates-custom">Custom style (other)</option>
					</select>
				</div>
				<div class="numbering-label"><span class="badge">2</span><span class="header-footer-label">Customize Style</span></div>
				...
				<span class="header-footer-label">Numbering (Continue from)</span>
				<div class="numbering-container">
					<div class="input-numbering">
						<label>Bates sequence starts from:</label>
						<input type="text" name="bates_start_from" placeholder="1">
						<span class="input-help tooltip">
						<span class="tooltiptext">Use this to continue a previous Bates stamping. Eg: previous numbering stopped at sequence 1001, continue now with 1002.</span>
						<i class="far fa-question-circle"></i>
						</span>
					</div>
					<div class="input-numbering">
						<label>Files counter starts from:</label>
						<input type="text" name="file_start_from" placeholder="1">
						<span class="input-help tooltip">
						<span class="tooltiptext">Relevant only when the file/exhibit counter is also used, besides the Bates sequence. Use this to continue a previous Bates stamping. Eg: Type the number of files already stamped.</span>
						<i class="far fa-question-circle"></i>
						</span>
					</div>
				</div>
				...
				<p class="help-block text-center">
					...
					<span class="input-help tooltip">
					<span class="tooltiptext">If you'll later need to start over and renumber your files, this can only be done using the originals.</span>
					<i class="far fa-question-circle"></i>
					</span>
				</p>
				<div class="more-options-btns-wrap">
					<button class="options-btn" type="button" id="start_task">Bates stamp</button>
