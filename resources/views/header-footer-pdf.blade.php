...
<section class="header-footer-pdf hidden after_upload" id="header_footer_section">
	<div class="container">
		...
		<div class="file-name-pdf">{!! t('Selected:') !!} <span class="file_name_here"></span></div>
		<form action="#" class="fixed-task-form">
			<div class="header-footer-content">
				<span class="header-footer-label">{!! t('Customize Style') !!}</span>
				<div class="header-footer-dropdown">
					...
					<div id="hf-filename" data-id="hf-filename" class="hf-format-customize">
						<div class="input-group">
							<div class="input-group-addon">{!! t('Filename') !!}</div>
					...
					<ul class="dropdown-menu-right">
						<li><a class="dropdown-menu-item-customize" data-value="hf-pages-arabic" href="#" >{!! t('Page 1, Page 2, Page 3') !!}</a></li>
						<li><a class="dropdown-menu-item-customize" data-value="hf-pages-roman" href="#" >{!! t('Page I, Page II, Page III') !!}</a></li>
						<li><a class="dropdown-menu-item-customize" data-value="hf-page-of-total" href="#">{!! t('Page 2 of 45') !!}</a></li>
						<li><a class="dropdown-menu-item-customize" data-value="hf-filename" href="#">{!! t('Filename') !!}</a></li>
						<li><a class="dropdown-menu-item-customize" data-value="hf-text-only" href="#">{!! t('Text only') !!}</a></li>
					</ul>
				</div>
				<div class="hf-dropdown-bottom-info">{!! t('Preview:') !!} Page 1, Page 2, Page 3</div>	
				<div class="hf-location-page">
					<span class="header-footer-label">{!! t('Preview:') !!}</span>
						...
						<label class="resolution-item">
							...
							<span class="resolution-item-checkmark">
								...
								<span class="input-help tooltip">
									<span class="tooltiptext">{!! array_key_exists(4, $PageBlocks) ? $PageBlocks[4] : 'Increase document margins to avoid overlapping existing text.' !!}</span>
				...
				<div class="more-options-box">
					<div class="more-options-flex">
						<div class="head-space">
							<label>{!! t('Apply only to pages') !!}</label>
							<div class="input-group">
								<input id="display_on_page" name="display_on_page" type="text" placeholder="{{ t("Example") }}: 1-10 {{ t("or") }} 12 {{ t("or odd or even or") }} 2,4,6,10" >
						...
						<div class="input-numbering">
							<label>{!! t('Start numbering from') !!}</label>
							<input id="start_from_page" type="text" name="start_from_page" placeholder="1">
							<span class="input-help tooltip">
								<span class="tooltiptext">{!! array_key_exists(5, $PageBlocks) ? $PageBlocks[5] : "Helpful, for example, when skipping over a 3 pages Introduction that's already numbered with romans." !!}</span>
								<i class="far fa-question-circle"></i>
							</span>
						</div> 
					</div>
				...
				<div class="more-options-btns-wrap">
                    <button class="options-btn" type="button" id="start_task">{!! t('Add header/footer') !!}</button>
