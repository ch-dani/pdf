    	...
    	<div class="container">
    		...
    		<div class="app-welcome">
    			<form action="#" id="drop_zone">
					...
					<h3>{!! t("UPLOAD <strong>DOCX</strong> FILE</h3>) !!}
    	...
    	<div class="language_not_selected">
    		<div class="fixed_text">
    			<div class="fixed_text_bg">
	    			{{ t("Please, select source language for translation.") }}
    			</div>
    		</div>
    	</div>
	...
	<section class="fixed-bottom-panel hidden after_upload" >
		<div class="translate_settings">
			...
			<div class="center_part hidden">
				<h3 class="page_num_title">{{ t("Page") }} <span class="viewed_page_num">1</span></h3>
			</div>
			
			<div class="right_part">
				<div class="buttons_part">
				    <button class="options-btn on_translated_page hidden" type="button" id="save_one_page" data-page_num="1">{{ t("Save") }}</button>
				    ...
				    <button class="options-btn" type="button" id="translate_all">{{ t("Translate") }}</button>
				    <button class="options-btn on_all_translated hidden" type="button" id="save_all">{{ t("Download") }}</button>
