...
@section('content')
    <div class="upload-top-info">
        <div class="container">
            <div class="app-title">
                <div class="wrapper">
                    <h1>{!! array_key_exists(1, $PageBlocks) ? $PageBlocks[1] : 'Repair PDF' !!}</h1>
                    <p>{!! array_key_exists(2, $PageBlocks) ? $PageBlocks[2] : 'Recover data from a corrupted or damaged PDF document' !!}</p>
                </div>
            </div>
    ...
    <div id="extract-pdf">
        <input type="button" class="button-task" value="Repair PDF" id="repair-pdf">
    </div>
    ...
    <div class="upload-top-info">
        <div class="container">
            <div class="app-title">
                <div class="wrapper">
                    <h1>{!! array_key_exists(4, $PageBlocks) ? $PageBlocks[4] : 'Ready to repair your files? Let\'s go!' !!}</h1>
                    <p>{!! array_key_exists(5, $PageBlocks) ? $PageBlocks[5] : 'Recover data from a corrupted or damaged PDF document' !!}</p>
                </div>
            </div>
            <div class="app-welcome">
                <form action="#">
