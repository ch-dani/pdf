                                ...
                                <div class="box-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group">
                                                <label for="maximum_allowed">Quantity of the maximum allowed symbols</label>
                                                <input value="{{ \App\Option::option('maximum_allowed') }}"
                                                       type="text" name="maximum_allowed"
                                                       id="maximum_allowed" class="form-control">
                                            </div>

                                            <div class="form-group">
                                                <label for="ip_restriction">IP restriction time: hrs</label>
                                                <input value="{{ \App\Option::option('ip_restriction') }}"
                                                       type="text" name="ip_restriction"
                                                       id="ip_restriction" class="form-control">
                                            </div>
                                            
                                            <div class="form-group">
                                                <label for="before_block">How many times can user try before blocked</label>
                                                <input value="{{ \App\Option::option('before_block') }}"
                                                       type="text" name="before_block"
                                                       id="before_block" class="form-control">
                                            </div>                                            
