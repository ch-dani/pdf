                    ...
                    <div class="col-xs-12">
                        <div class="box">
                            <div class="box-header">
                                ...
                                <a href="{{ route('admin-add-blog-cats') }}"  class="btn btn-success">Create</a>
                            </div>
                            <div class="box-body">
                                <style>
                                ...
                                <table id="Articles" class="table table-bordered table-hover">
                                    ...
                                    @foreach ($Articles as $Article)
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    <a href="{{ route('edit_blog_cat', ['id' => $Article->id]) }}" class="btn btn-info">Edit</a>
                                                    @if(false)
                                                    <a href="{{ route('article', ['id' => $Article->url]) }}" target="_blank" class="btn btn-success">Show</a>
                                                    @endif
                                                    <a href="#" class="btn btn-danger DeleteBlogCategory" data-id="{{ $Article->id }}">Delete</a>
                                                </div>
                                            </td>
                                        </tr>
                                    @endforeach
