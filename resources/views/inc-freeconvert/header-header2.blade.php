<header>
    <div class="container">
        <div class="row">
            <div class="col-xl-2 col-lg-2 col-md-10 col-sm-10 col-10">
                ...
                @endphp
                <div class="logo">
                    <a href="{{$home_link}}">@php include(public_path('freeconvert/img/logo.svg')) @endphp</a>
                </div>
            </div>
            <div class="col-xl-10 col-lg-10 col-md-2 col-sm-2 col-2">
                ...
                <nav>
                    <ul class="module__main-menu"><li class="pages_menu_wrapper"><ul class="pages_menu">
                        <li class="not_empty">
    ...
    <li class="login" style="margin-left: 10px; {{ $lang_code !== 'en' ? 'top: 15%;' : 'top: 28%;' }}">
        @if (\Auth::check())
            <a href="/{{ $lang_code === 'en' ? '' : $lang_code . '/' }}account">{{ t("Account") }}</a>
        @else
            <a href="#" class="menu-login">{{ t('Login') }}</a>
        @endif
    </li>
    <li class="sign_up">
        <a href="/{{ $lang_code === 'en' ? '' : $lang_code . '/' }}contact"">{{ t('Contact Support') }}</a>
    </li>
