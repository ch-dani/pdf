                            ...
                            <tr>
                                <td class="content-cell"
                                    ...
                                    <p style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #74787E; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                        If you really want to reset your password press button below.</p>
                                                                ...
                                                                <tr>
                                                                    <td style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box;">
                                                                        <a href="{{ $url }}" class="button button-blue"
                                                                           style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; border-radius: 3px; box-shadow: 0 2px 3px rgba(0, 0, 0, 0.16); color: #FFF; display: inline-block; text-decoration: none; -webkit-text-size-adjust: none; border-top: 10px solid #3097D1; border-right: 18px solid #3097D1; border-bottom: 10px solid #3097D1; border-left: 18px solid #3097D1; background-color: #6834b7; border-color: #6834b7;"
                                        ...
                                        <tr>
                                            <td style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box;">
                                                <p style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #74787E; line-height: 1.5em; margin-top: 0; text-align: left; font-size: 12px;">
                                                    ...
                                                    button, copy and paste the URL below into your web browser: <a
                                                            href=""
                            ...
                            <tr>
                                <td class="content-cell" align="center"
                                    ...
                                    <p style="font-family: Avenir, Helvetica, sans-serif;box-sizing: border-box; line-height: 1.5em; margin-top: 0; color: #AEAEAE;font-size: 12px; text-align: center;">
                                        <span style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #fff;"> © {{ date('Y') }}. All rights reserved.</span>
                                    </p>
                                </td>
                            </tr>
                        </table>
...
<img src="https://u8647736.ct.sendgrid.net/wf/open?upn=QOj-2FXWMwrtGhHdk0ao-2FYqabMxZljPQQ85zGT-2FUB8m60pejI2BtWPl6Xc5OPJtrqydqKa-2Fwh-2Bxs17EBR3qZUJ810my9YBq3OWPHHcL-2FQnsf9o1BZtnbYWlAOZum11h-2FUd8n8cwjQpTP7qPWbj1qIjlMDsGXaIyv4wFEGnSzDOSXfHVFb-2FzkDLczR-2Bxe8maQlOmvZ4BBRFgP9Bt8ZsVnVYXsGq0Fi3f0QPqrQ8ZvZ1r8A-3D"
