...
@section('content')
    ...
    <section class="n-up-pdf" style="display: none;">
        <div class="container">
            <div class="file-name-pdf">{{ t("Selected") }}: Cut sheet 3.25.pdf</div>
            <div class="n-up-title">{{ t("Choose style") }}</div>
                    ...
                    <label>
                        ...
                        <div class="n-up-checkmark">
                            <div class="n-up-preview">
                                ...
                                <span>8-up {{ t("vertical") }}</span>
                            </div>
                        </div>
                    </label>
                </div>
            </div>
            <div class="n-up-title">{{ t("Pages per sheet") }}</div>
            <form class="fixed-task-form">
                <div class="more-options-box">
                    <div class="pdf-grayscale-form-options">
                        ...
                        <div class="n-up-title">{{ t("Page ordering") }}</div>
                        <div class="image-radio-item">
                            <div class="btns-resolution">
                                <label class="resolution-item">
                                    ...
                                    <span class="input-help tooltip">
                                        <span class="tooltiptext">{{ t("Orders pages from left to right.") }}</span>
                                ...
                                <label class="resolution-item">
                                    ...
                                    {{ t("Vertical") }}
                                    <span class="input-help tooltip">
                                        <span class="tooltiptext">{{ t("Orders pages from top to bottom.") }}</span>
                                        <i class="far fa-question-circle"></i>
                                    </span>
                                </span>
                                </label>
                    ...
                    <div class="checkbox-item-content">
                        <label>
                            ...
                            <span>{{ t("Preserve original page size") }}</span>
                        </label>
                        <span class="input-help tooltip">
                            <span class="tooltiptext">{{ t("Select this option if you'd like the result PDF to have the same page size as the original, downscaling the collated pages.") }}</span>
                            <i class="far fa-question-circle"></i>
                        </span>
                    </div>
                </div>
                <div class="more-options-btns-wrap">
                    <button class="options-btn" id="n-up-pdf">{{ t("N-up PDF") }}</button>
