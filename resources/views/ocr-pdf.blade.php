            ...
            <div class="page_item">
                ...
                <div class="recognize-right-info">
                    ...
                    <div class="recognize-info-block">
                        <p>{!! array_key_exists(7, $PageBlocks) ? $PageBlocks[7] : 'Quick single page mode' !!}</p>
                        <div class="recognize-btns-block">
                            ...
                            <a href="#"
                               class="button-green">{!! array_key_exists(8, $PageBlocks) ? $PageBlocks[8] : 'Recognize text on this page' !!}</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <form class="fixed-task-form">
            <div class="recognize-settings">
                <div class="recognize-settings-block">
                    <span class="recognize-settings-name">{{ t("Language") }}:</span>
                ...
                <div class="recognize-settings-block">
                    <span class="recognize-settings-name">{{ t("Output formats") }}:</span>
                    <ul class="output-formats-btns">
                        <li class="output-btn output-btn-active" data-val="pdf">{{ t("Searchable PDF") }}</li>
                        <li class="output-btn" data-val="text">{{ t("Text file") }}</li>
                    </ul>
                </div>
            </div>
            <div class="more-options-btns-wrap">
                <button class="options-btn" type="button"
                        id="start_task">{!! array_key_exists(9, $PageBlocks) ? $PageBlocks[9] : 'Recognize text on all pages' !!}</button>
            </div>
        </form>
    </section>
