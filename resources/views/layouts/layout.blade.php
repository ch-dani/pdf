    ...
    <div class="footer-wrap">
        <div class="container" style="position: relative;">
            ...
            <div class="footer_soc" style="color: white;">
                ...
                <a target="_blank" href="https://www.youtube.com/channel/UCEPnE2Uq5Q02g2dNrh0_vxQ"><i
...
@if($current_url=='translate')
    ...
    <script src="{{ asset('/js/new_editor/libs/translate_pdf.js')}}"></script>
@endif
...
<script>
    ...
    var scripts = [
        ...
        , {
            ...
            }, data: {"data-app-key": "kmnvanr1sm5jlg1", "defer": "defer"}, id: "dropboxjs"
        },
        {
            script: "https://apis.google.com/js/client.js?onload=loadPickerCallback", callback: function () {
            }, data: {"defer": "defer"}
        },
        {
