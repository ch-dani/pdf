        ...
        <section class="section_top converting">
            <div class="container">
                <div class="title-wrapper">
                    <h2 class="h30-title title_main">{{ t('Online PDF Merger') }}</h2>
                    <h3 class="sub-title">{{ t('Combine PDF files online for free in just seconds.') }}</h3>
                </div>
                ...
                <div class="downloader">
                    <div class="downloader__upload">
                        ...
                        <div class="downloader__text">{{ t('Merge files') }}</div>
                ...
                <div class="link_convert">
                    <ul class="save">
                        <li class="save__li">
                            <a href="#">
                                <img src="{{ asset('freeconvert/img/split.svg') }}" width="23" height="23">
                                {{ t('Select to split') }}
                            </a>
                        </li>
                        <li class="save__li">
