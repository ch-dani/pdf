    <section class="login-modal">
		...
		<div id="closeModal">&times;</div>
            <div class="lolin-modal-block">
                ...
                <a class="signed-google" href="#">{{ t("Sign-up with Google") }}</a>
           	 <p>{!! t('By logging in with Google you agree to the <a href="/terms">terms</a> and <a href="/policy">privacy policy</a>') !!}</p>
            </div>
        </div>
    </section>
